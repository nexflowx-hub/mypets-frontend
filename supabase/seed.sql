-- Deterministic MyPets staging/demo seed.
-- Safe to re-run. Fictional story/impact records are explicitly is_demo = true.
...
insert into public.stories (
  ...
  ('ana-porto', 'PROTECTOR', 'Ana', 'Porto', 'PT', 'EUR',
   'Cuida atualmente de 14 gatos.', 'Cuida atualmente de 14 gatos.', 'Currently caring for 14 cats.',
   '/images/story-ana.jpg', 'Ana sentada num degrau rodeada por gatos resgatados no Porto',
   '["RACAO","MEDICACAO","ESTERILIZACAO"]'::jsonb, 42000, 28500, true, true, 1),
  ('carlos-sao-paulo', 'PROTECTOR', 'Carlos', 'São Paulo', 'BR', 'BRL',
   'Alimenta e acompanha 23 cães numa comunidade local.', 'Alimenta e acompanha 23 cães em uma comunidade local.', 'Feeds and looks after 23 dogs in a local community.',
   '/images/story-carlos.jpg', 'Carlos ajoelhado entre cães resgatados numa comunidade de São Paulo',
   '["RACAO","VACINACAO","TRANSPORTE"]'::jsonb, 240000, 167000, true, true, 2),
  ('luna', 'ANIMAL', 'Luna', null, 'PT', 'EUR',
   'Encontrada ferida. Está em tratamento.', 'Encontrada ferida. Está em tratamento.', 'Found injured. Currently in treatment.',
   '/images/story-luna.jpg', 'Luna, cadelinha em recuperação sobre coberta clínica',
   '["CONSULTA","CIRURGIA","RECUPERACAO"]'::jsonb, 42000, 28500, true, true, 3),
  ('milo', 'ANIMAL', 'Milo', null, 'PT', 'EUR',
   'Resgatado da rua. Precisa de cuidados.', 'Resgatado da rua. Precisa de cuidados.', 'Rescued from the street. Needs care.',
   '/images/story-milo.jpg', 'Milo, cão jovem resgatado da rua, a olhar para a câmara',
