      ...
      <div className="mx-auto grid max-w-[1440px] gap-8 px-4 sm:px-6 lg:grid-cols-[1.05fr_1fr] lg:px-8">
        <div className="relative isolate flex min-h-[340px] flex-col justify-center overflow-hidden rounded-2xl bg-petrol p-7 sm:p-10 lg:min-h-[420px]">
          ...
          <div className="relative z-10 max-w-sm">
            ...
            <button onClick={() => router.push(growthDestination("/join/ajudar", { campaign: "always_on", cta: "impact_cta" }))} className="group mt-7 inline-flex min-h-11 items-center gap-2 rounded-lg bg-white px-5 text-[14px] font-bold text-petrol transition-all hover:bg-cream hover:shadow-xl focus-visible:outline-2 focus-visible:outline-coral">
  ...
  return (
    <section id="parceiros" className="border-t border-border/60 bg-white py-12">
      <div className="mx-auto flex max-w-[1440px] flex-col items-center gap-5 px-4 text-center sm:px-6 lg:flex-row lg:justify-between lg:px-8 lg:text-left">
        ...
        <a href="/join/projeto?utm_source=mypets&utm_medium=onsite&utm_campaign=projects&src_cta=partner_band" className="group inline-flex min-h-11 items-center gap-2 rounded-full bg-coral px-6 text-[14px] font-bold text-white shadow-[0_8px_22px_-10px_rgba(255,98,88,0.6)] transition-all hover:bg-coral-dark focus-visible:outline-2 focus-visible:outline-coral">{dict.partner.cta}<ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" aria-hidden /></a>
      </div>
    </section>
  );
}
